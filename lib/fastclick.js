...
;(function () {
	...
	*/
	...
	FastClick.prototype.determineEventType = function(targetElement) {
		...
		if (deviceIsAndroid && targetElement.tagName && targetElement.tagName.toLowerCase() === 'select') {
			return 'mousedown';
		}
    ...
    // Referencing pull request that allows "needsclick" option to work.
    // @ https://github.com/ftlabs/fastclick/issues/268
